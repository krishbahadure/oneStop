...
export default function CoursesPage() {
  ...
  if (loading) return <StudentLayout><PageLoader message="Loading courses…" /></StudentLayout>;
    ...
    <StudentLayout>
      <div className="min-h-full bg-[hsl(36,33%,97%)]">
        <div className="bg-white border-b border-[hsl(220,18%,91%)] px-8 py-5">
          <h1 className="text-2xl font-black text-[hsl(226,64%,14%)]">Courses</h1>
          <p className="text-sm text-[hsl(220,14%,50%)] mt-0.5">Explore undergraduate, postgraduate, and diploma programmes available in J&K</p>
        </div>
        ...
        <div className="px-8 py-6 max-w-[1200px]">
          ...
          {filtered.length === 0 ? (
            <PageEmpty message="No courses match your filters." icon={BookOpen} />
          ) : (
